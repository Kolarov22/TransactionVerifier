...
import com.transverify.analytics.kafka.KafkaErrorHandler;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, TransactionDTO> transactionConsumerFactory() {
        ...
        ErrorHandlingDeserializer<TransactionDTO> errorHandlingDeserializer = new ErrorHandlingDeserializer<>(valueDeserializer);

        return new DefaultKafkaConsumerFactory<>(configMap, new StringDeserializer(), errorHandlingDeserializer);
    }
